...
export class ChurchPage {
  ...
  ionViewDidEnter() {
    ...
    this.locationHandler.showLoader("Loading nearby towing services....");
    ...
    this.platform.ready().then((readySource) => {
      ...
      (isAvailable) => {
       ...
       if(isAvailable){
        ...
        setTimeout(() => {
          this.locationHandler.showLoader("Loading nearby hospitals....");
          //render the map and nearby services
          this.renderNearByServices();
        }, 10000);
        if(location_state){
  ...
  initMap(){
    ...
    this.geolocation.getCurrentPosition().then((position) => {
      ...
      this.getNearbyActivities("towing", this.current_location, current);
    });
