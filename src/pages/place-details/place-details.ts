...
export class PlaceDetailsPage {
  ...
  apiKey: string = "AIzaSyATVf1yeihZEnKiDXJKZm4eP0hlgDCohc0"; //API KEY
  map:any;
  comtent_map:any;
  message:any;
  ...
  constructor(public navCtrl: NavController,
    ...
    public connectionListerner:ConnectivityServiceProvider,
    public favouriteplace: FavouriteplaceProvider,
...
*/
 ...
 /* let Place = {
    ...
    url: place.place_map_url,
    description: place.place_address,
    photo: this.place_photos,
    rating: place.rating
  }

    this.favouriteplace.savefavourite(Place).then((data) => {
