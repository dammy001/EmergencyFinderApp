...
export class LocationHandlerProvider {
  ...
  constructor(public actionSheetCtrl: ActionSheetController,public location:LocationAccuracy,private alert: AlertController, private toast: ToastController, private loader: LoadingController) {
  }
